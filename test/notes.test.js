...
describe('Note Router Tests', () => {
  ...
  const expectedFields = ['id', 'title', 'content', 'createdAt', 'updatedAt', 'tags'];
  ...
  describe('GET /api/notes', function() {
    ...
    it('should be able to search by folders', () => {
    ...
    it('should be able to search by tags', () => {
      return req('get', '/?tagId=222222222222222222222202')
        .then(res => {
    ...
    it('should be able to search with multiple filters', () => {
      return req('get', '/?searchTerm=cat&folderId=111111111111111111111101&tagId=222222222222222222222201')
        .then(res => {
  ...
  describe('PUT /api/notes/:id', () => {
    ...
    it('should reject requests with an invalid tagId',() => {
      return req('put', '/faaaaaaaaaaaaaaaaaaaaaaa')
        .send({
          title: 'Testing title here!',
          content: 'Who needs it?',
          folderId: 'faaaaake',
          tags: ['faaaaaaaaaaaaaaaaaaaaaaa']
        })
        .then(res => {
          expect(res).to.have.status(400);
        });
